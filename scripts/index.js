const UI = (function () {
    ...
    const loadApp = () => {
        document.querySelector('#app-loader')
        .classList.add('hidden', 'true');

        document.querySelector('main')
        .removeAttribute('display-none');
    };
    ...
    const drawWeatherData = (data, location) => {
        ...
        for(let i = 0; i <= 6; i++){
            ...
            dailyWeatherModel.children[1].children[1].children[0].setAttribute('src',
...
const LOCALSTORAGE = (function(){
    ...
    const remove = (index) => {
        if (index < savedCities.length){
            ...
            localStorage.setItem('savedItems', JSON.stringify(savedCities));
        }
    }
...
const WEATHER = (function() {
    const   darkSkyKey = 'a8490f61795c5d47ef9d04d93f40fb03',
            geocoderKey = '90e17a04bb5e4df787971453653553e5';
